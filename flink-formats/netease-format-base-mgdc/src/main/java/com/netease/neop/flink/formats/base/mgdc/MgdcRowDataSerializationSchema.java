...
import com.netease.neop.flink.formats.base.mgdc.entity.MgdcEntity;
 ...
 * @ Description：序列化为mgdc格式
 * 输出：rowtime,pid,log_type,log_time,log_date,source
 * 其中source是jsonObject，会自动封装用户字段为source
 */
                ...
                switch (fieldName) {
                    ...
                    default:
                        ...
                        if (element.isNullAt( i ))
                            break;
                        sourceObj.put( fieldName, getJsonValue( typeRoot, element, Integer.valueOf( i ) ) );
                        break;
                }
            }
